...
The dashboard serves `http://127.0.0.1:4317`. It indexes local Claude, Codex, Cline, Antigravity, Command Code, and OpenCode transcript/session stores plus Cursor, Hermes, Pi, and usage-collector metric records; secret-like content is redacted before anything is persisted.
