...
The dashboard serves `http://127.0.0.1:4317`. It indexes local Claude, Codex, Cline, Antigravity, Command Code, Evot, OpenCode, Fireworks, and usage-collector stores; secret-like content is redacted before anything is persisted.
